...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_for_error_Map = QtWidgets.QVBoxLayout()
        self.verticalLayout_for_error_Map.setObjectName("verticalLayout_for_error_Map")
        self.gridLayout.addLayout(self.verticalLayout_for_error_Map, 0, 0, 1, 1)
        self.gridLayout_2.addWidget(self.frame_for_errorMap, 3, 0, 1, 1)
...
"background-color: rgb(0, 0, 0);")
    ...
    def error_map(self):
        ...
        if (comboX == 0 and comboY == 1) or  (comboX == 1 and comboY == 0) :
            ...
            if comboX == 1 and comboY == 0:
                matrix1=matrix1.T
                fig, self.ax = plt.subplots(figsize=(1, 5))
    ...
    def toggle_errormap (self, fig):
        if self.bool_heatmap == 0:
            ...
            self.frame_for_errorMap.addWidget(self.canvas1)
            self.bool_heatmap = 1
        else:
            self.canvas1.hide()
            self.canvas1 = FigureCanvasQTAgg(fig)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_for_Z_axis.setText(_translate("MainWindow", "Sameh"))
